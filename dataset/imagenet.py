...
class ImageNetDataset(Dataset):
    ...
    def __init__(self, data_path, split, transform=None, num_classes=1000, random_seed=42):
        '''
...
if __name__ == "__main__":
    ...
    imagenet_data = ImageNetDataset('data/imagenet', 'train', transform=transformations)

    train_loader = torch.utils.data.DataLoader(
        dataset=imagenet_data, batch_size=10, shuffle=True
    )
